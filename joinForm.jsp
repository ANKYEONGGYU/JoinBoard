...
<body> 
<form action="joinProcess.jsp" name="joinform" method="post" onsubmit="return checks()"> 
<table border="1" bordercolor="grey" align="center"> 
	...
	<tr> 
	    ...
	    <td><input size="15" type="password" name="password" id="password"> 4~12자의 영문 대소문자와 숫자로만 입력</td> 
	</tr> 
	<tr> 
	...
	<tr>
	    ...
	    <td><input size="7" type="text" name="id_num" id="id_num"> - 
	        <input size="7" type="password" name="id_num_back" id="id_num_back"
	        onBlur="check_jumin()"> 예)123456-1234567</td>
	</tr>
	<tr> 
	    <td align="center" bgcolor="lightgrey"><b>생일</b></td> 
	    <td><input type="text" AUTOCOMPLETE="off" name="year" id="year" size="4" readonly><b> 년</b>
	        <input type="text" AUTOCOMPLETE="off" name="month" id="month" style="width: 20px;" readonly><b> 월</b>
	        <input type="text" AUTOCOMPLETE="off" name="date" id="date" style="width: 20px;" readonly><b> 일</b></td>
	</tr>
	<tr>
	...
	<tr> 
	    ...
	    <td><textarea cols="50" style="margin: 0px; height: 300px; width: 480px" name="intro"></textarea> <!--크기 조정 가능--></td>
    </tr> 
    <tr> 
